  ...
  return (
    <div className="jg__daten">
      ...
      <p>
        ...
        oder Löschung dieser Daten zu verlangen. Wenn Sie eine Einwilligung zur
        Datenverarbeitung erteilt haben, können Sie diese Einwilligung jederzeit
        f&uuml;r die Zukunft widerrufen. Au&szlig;erdem haben Sie das Recht,
      ...
      <p>
        ...
        <br />
        (0,20 &euro; / Anruf aus dem deutschen Festnetz. Aus den Mobilfunknetzen
        höchstens 0,60 &euro; / Anruf.)
      </p>
      ...
      <p>
        ...
        Datenschutzerklärung erläutert, welche Daten wir erheben und wof&uuml;r
      ...
      <p>
        ...
        uns, bis der Zweck f&uuml;r die Datenverarbeitung entfällt. Wenn Sie ein
      ...
      <p>
        ...
        erfolgt die Datenverarbeitung zusätzlich auf Grundlage von &sect; 25
        ...
        erfolgen. &Uuml;ber die jeweils im Einzelfall einschlägigen
      ...
      <p>
        Viele Datenverarbeitungsvorgänge sind nur mit Ihrer ausdr&uuml;cklichen
        Einwilligung möglich. Sie können eine bereits erteilte Einwilligung
        jederzeit widerrufen. Die Rechtmä&szlig;igkeit der bis zum Widerruf
      ...
      <p>
        ...
        DENN, WIR KöNNEN ZWINGENDE SCHUTZW&Uuml;RDIGE GR&Uuml;NDE F&Uuml;R DIE
      ...
      <p>
        Im Falle von Verstö&szlig;en gegen die DSGVO steht den Betroffenen ein
      ...
      <p>
        ...
        aushändigen zu lassen. Sofern Sie die direkte &Uuml;bertragung der Daten
      ...
      <ul>
        ...
        <li>
          Wenn die Verarbeitung Ihrer personenbezogenen Daten unrechtmä&szlig;ig
        ...
        <li>
          ...
          Rechtsanspr&uuml;chen benötigen, haben Sie das Recht, statt der
        ...
        <li>
          ...
          &uuml;berwiegen, haben Sie das Recht, die Einschränkung der
      ...
      <p>
        ...
        Person oder aus Gr&uuml;nden eines wichtigen öffentlichen Interesses der
      ...
      <p>
        ...
        Schaden an. Sie werden entweder vor&uuml;bergehend f&uuml;r die Dauer
        einer Sitzung (Session-Cookies) oder dauerhaft (permanente Cookies) auf
      ...
      <p>
        Sie können Ihren Browser so einstellen, dass Sie &uuml;ber das Setzen
        von Cookies informiert werden und Cookies nur im Einzelfall erlauben,
        die Annahme von Cookies f&uuml;r bestimmte Fälle oder generell
        ausschlie&szlig;en sowie das automatische Löschen der Cookies beim
        Schlie&szlig;en des Browsers aktivieren. Bei der Deaktivierung von
      ...
      <p>
        Diese Website nutzt Cookies, welche die IP-Adresse des Besuchers aus
        Sicherheitszwecken protokolliert und speichert. Weitere Informationen
        dazu finden sie in den Datenschutzbestimmungen unseres Hosters{" "}
        <a href="https://docs.github.com/de/site-policy/privacy-policies/github-general-privacy-statement">
          Datenschutzerklärung Git-Hub
        </a>
      </p>
      ...
      <p>
        ...
        zusammenhängt oder zur Durchf&uuml;hrung vorvertraglicher
      ...
      <p>
        ...
        einer Seite l&auml;dt Ihr Browser die benötigten Fonts in ihren
      ...
      <h3>Cookiebot</h3>{" "}
      <p>
        Cookiebanner wird von Cookiebot bereitgestellt. Weitere Informationen
        zum Anbieter:{" "}
        <a href="https://www.cookiebot.com/">https://www.cookiebot.com/</a>
      </p>
      <br />
      <p>
        Die Datenschutzerklärung wurde erstellt mit{" "}
